...
编号按分类顺序连续排列（1-39），0 为退出。

| 编号 | 功能 | 编号 | 功能 | 编号 | 功能 | 编号 | 功能 |
|------|------|------|------|------|------|------|------|
| 1 | 系统信息 | 11 | 日志清理 | 21 | 容器状态 | 31 | 轻量换源 |
| 2 | 时间/用户 | 12 | 时间同步 | 22 | 镜像/卷 | 32 | Homebrew |
| 3 | 运行服务 | 13 | 网络端口 | 23 | 安装 Docker | 33 | 全能换源 |
| 4 | 主机/时区 | 14 | DNS 测试 | 24 | 磁盘管理 | 34 | 初始化 |
| 5 | 进程/服务 | 15 | Ping 测试 | 25 | 盘位映射 | 35 | 卸载工具箱 |
| 6 | 磁盘占用 | 16 | 性能测试 | 26 | 验盘（!） | 36 | 功能检查 |
| 7 | 系统更新* | 17 | SSH 管理 | 27 | SMART 长测 | 37 | 状态面板 |
| 8 | 系统清理* | 18 | BBR 优化 | 28 | Fail2ban | 38 | 组件版本 |
| 9 | 基础工具 | 19 | 防火墙 | 29 | 用户管理 | 39 | 更新脚本 |
| 10 | Swap 管理 | 20 | 证书检查 | 30 | 定时任务 | 0 | 退出 |

> `*` 仅提示命令不执行 · `!` 验盘/擦盘为破坏性操作，须先 `--plan`
