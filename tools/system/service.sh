...
# -----------------------------------------------------------------------------
# 运行方式
#   本地：cd /opt/netool && ./main.sh service
#   远程：bash <(curl -fsSL https://gitee.com/suser747/netool/raw/master/main.sh) service
#   直接：bash tools/system/service.sh [参数...]  （需在 tools 目录结构完整时）
# -----------------------------------------------------------------------------
