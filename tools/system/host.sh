...
# -----------------------------------------------------------------------------
# 运行方式
#   本地：cd /opt/netool && ./main.sh host
#   远程：bash <(curl -fsSL https://gitee.com/suser747/netool/raw/master/main.sh) host
#   直接：bash tools/system/host.sh [参数...]  （需在 tools 目录结构完整时）
# -----------------------------------------------------------------------------
