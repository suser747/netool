...
# -----------------------------------------------------------------------------
# 运行方式
#   本地：cd /opt/netool && ./main.sh logclean
#   远程：bash <(curl -fsSL https://gitee.com/suser747/netool/raw/master/main.sh) logclean
#   直接：bash tools/system/logclean.sh [参数...]  （需在 tools 目录结构完整时）
# -----------------------------------------------------------------------------
