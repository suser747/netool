...
# -----------------------------------------------------------------------------
# 运行方式
#   本地：cd /opt/netool && ./main.sh system
#   远程：bash <(curl -fsSL https://gitee.com/suser747/netool/raw/master/main.sh) system
#   直接：bash tools/system/system.sh [参数...]  （需在 tools 目录结构完整时）
# -----------------------------------------------------------------------------
